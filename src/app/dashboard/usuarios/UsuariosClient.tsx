              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <input required type="email" placeholder="ejemplo@gmail.com" autoComplete="off" className="w-full rounded-xl border border-sys-border bg-sys-panel px-4 py-2 text-sm text-sys-text focus:border-sys-primary focus:outline-none" value={form.email} onChange={(e) => setForm({...form, email: e.target.value})} />
                  </div>
                  <div className="flex flex-col gap-1">
