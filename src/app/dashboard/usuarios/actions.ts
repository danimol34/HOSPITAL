...
export async function createUser(formData: FormData) {
  ...
  const user_metadata = {
    ...
    fecha_ingreso_ministerio: formData.get('fecha_ingreso_ministerio') as string,
    vacaciones_disfrutadas: formData.get('vacaciones_disfrutadas') as string,
    fecha_ingreso_admin_publica: formData.get('fecha_ingreso_admin_publica') as string,
